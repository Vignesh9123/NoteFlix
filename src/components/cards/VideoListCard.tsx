...
function VideoListCard({videoDetails, type, index, videoList, setVideoList, playlistId, isSelected, selectMode}: {videoDetails: IVideoDetails, type: string, index: number, videoList: IVideoDetails[], setVideoList: (videoList: IVideoDetails[]) => void, playlistId?: string, isSelected?: boolean, selectMode?: boolean}) {
